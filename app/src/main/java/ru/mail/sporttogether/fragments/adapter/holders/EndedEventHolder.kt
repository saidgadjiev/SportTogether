...
import ru.mail.sporttogether.fragments.adapter.presenters.EndedEventsHolderPresenter
...
class EndedEventHolder(v: View) :
        AbstractTwoActionHolder<EndedEventsHolderPresenter>(v, null),
        EndedEventsView {

    init {
        data.action2Text.set(v.context.getString(R.string.share).toUpperCase())
        presenter = EndedEventsHolderPresenter(this)
    }
