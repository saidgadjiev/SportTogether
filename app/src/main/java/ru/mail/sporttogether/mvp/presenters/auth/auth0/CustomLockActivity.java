...
public class CustomLockActivity extends AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private static final int VK_AUTH_REQUEST_CODE = 10485;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(com.auth0.android.lock.R.layout.com_auth0_lock_activity_lock);
        resultMessage = (TextView) findViewById(com.auth0.android.lock.R.id.com_auth0_lock_result_message);
        ScrollView rootView = (ScrollView) findViewById(com.auth0.android.lock.R.id.com_auth0_lock_content);
        ...
        loginErrorBuilder = new LoginErrorMessageBuilder(com.auth0.android.lock.R.string.com_auth0_lock_db_login_error_message, com.auth0.android.lock.R.string.com_auth0_lock_db_login_error_invalid_credentials_message);
    ...
    public void onBackPressed() {
        ...
        LocalBroadcastManager.getInstance(CustomLockActivity.this).sendBroadcast(intent);
        super.onBackPressed();
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        switch (requestCode) {
            case WEB_AUTH_REQUEST_CODE:
                ...
                break;
            case CUSTOM_AUTH_REQUEST_CODE: case VK_AUTH_REQUEST_CODE:
                lockView.showProgress(false);
                if (currentProvider != null) {
    ...
    private AuthCallback authProviderCallback = new AuthCallback() {
        ...
        public void onFailure(final AuthenticationException exception) {
            ...
            final String message = authError.getMessage(CustomLockActivity.this);
        ...
        public void onFailure(final AuthenticationException error) {
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    String message = authError.getMessage(CustomLockActivity.this);
                    showErrorMessage(message);
                }
            });
        }
    ...
    private AuthenticationCallback<DatabaseUser> createCallback = new AuthenticationCallback<DatabaseUser>() {
        ...
        public void onFailure(final AuthenticationException error) {
            ...
            handler.post(new Runnable() {
                @Override
                public void run() {
                    String message = signUpErrorBuilder.buildFrom(error).getMessage(CustomLockActivity.this);
                    showErrorMessage(message);
                }
            });
        }
    ...
    private AuthenticationCallback<Void> changePwdCallback = new AuthenticationCallback<Void>() {
        ...
        public void onFailure(AuthenticationException error) {
            ...
            handler.post(new Runnable() {
                @Override
                public void run() {
                    String message = new AuthenticationError(R.string.com_auth0_lock_db_message_change_password_error).getMessage(CustomLockActivity.this);
                    showErrorMessage(message);
                }
            });
        }
